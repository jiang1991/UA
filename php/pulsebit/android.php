        ...
        <div class="col-md-6" style="border-left:0px solid #ccc;">
          <div class="row text-center">
            <div class="margin-bottom-20">
              <i class="fa fa-android fa-3x" aria-hidden="true"></i><br>
              <br>
              <a href="http://viatomtech.com.cn/" class="label label-success" style="font-size: 16px">
              <i class="fa fa-download" aria-hidden="true"></i> 下载Android版</a>
              <br>
              <div style="margin:5px 0 0 0;">适用于Android设备</div>
            </div>
          </div>
        </div>
      </div>
